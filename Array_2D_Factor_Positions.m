...
% name of svg
svg_cart_name = sprintf("Figs/%dx%d_%.2f_theta%.1f_phi%.1f.svg",Nx,Ny, d/lambda, rad2deg(scan_theta), rad2deg(scan_phi));
svg_sph_name = sprintf("Figs/sph%dx%d_%.2f_theta%.1f_phi%.1f.svg",Nx,Ny, d/lambda, rad2deg(scan_theta), rad2deg(scan_phi));
%% Calculate AF
